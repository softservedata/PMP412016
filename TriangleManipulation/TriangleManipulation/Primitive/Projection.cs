...
namespace TriangleManipulation.Primitive
{
    class Projection
    {
        // повинні бути такі щоб обєкт помістився в з зрізану піраміду. Дно піраміди перпендикулярне до кришталика ока
        ...
        public Projection(double _r, double _l, double _b, double _t, double _n, double _f)
        {
            R = _r;
            L = _l;
            B = _b;
